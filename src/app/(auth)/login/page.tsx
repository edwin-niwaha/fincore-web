...
export default function LoginPage() {
  ...
  return (
    <AuthCard
      title="Welcome back"
      subtitle="Sign in to continue to your FinCore workspace."
    >
      <form className="grid gap-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <Link className="font-bold text-[#127D61]" href="/forgot-password">
            Forgot password?
          </Link>
        </div>
      ...
      <p className="mt-6 text-center text-sm text-slate-600">
        New to FinCore?{' '}
        <Link className="font-bold text-[#127D61]" href="/register">
          Create an account
        </Link>
      </p>
    </AuthCard>
